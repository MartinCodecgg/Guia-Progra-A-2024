...
Procedure InciC(mt:tm1;nrocli:tv1;n,m:byte);          //PREGUNTAR este Inciso, si esto lo que pedia o no
                                                        //El enunciado no pide que guarde la cantidad de compras por cliente
Var                                                         // solo el monto total de cada uno
   i,j,compras:byte;
   acumMonto:real;
