...
begin
     ...
     while not eof(Arch) do
           begin
                ...
                begin
                Vreg[n].fecha:=ord(fecha[4])+ord(fecha[5])-2*ord('0');    //Entonces para un solo numero, el ord del numero menos el ord del cero
                writeln('segundo write', Vreg[n].fecha);                       //si son dos numeros 2 veces ord del 0
                end;                                                              // asi funciona bien
                readln(arch);
           end;
